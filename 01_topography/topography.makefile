...
raster_slice: crop zvals
	...
	mkdir -p ./shade/
	gdal_calc.py -A ./shadedrelief.tmp.tif --outfile=./shade/1.tmp.tif --calc="50*(A<50)"   --NoDataValue=0
	gdal_calc.py -A ./shadedrelief.tmp.tif --outfile=./shade/2.tmp.tif --calc="100*(A<100)" --NoDataValue=0
	gdal_calc.py -A ./shadedrelief.tmp.tif --outfile=./shade/3.tmp.tif --calc="150*(A<150)" --NoDataValue=0
	gdal_calc.py -A ./shadedrelief.tmp.tif --outfile=./shade/4.tmp.tif --calc="200*(A<200)" --NoDataValue=0
